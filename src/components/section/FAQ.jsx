      ...
      <div className="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-24 lg:px-6 ">
        ...
        <div className="max-w-screen-md mx-auto">
          <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
            <h3 id="accordion-flush-heading-1" onClick={() => togglePara(1)}>
              <button
                type="button"
            ...
            <h3 id="accordion-flush-heading-2" onClick={() => togglePara(2)}>
            ...
            <h3 id="accordion-flush-heading-3" onClick={() => togglePara(3)}>
            ...
            <h3 id="accordion-flush-heading-4" onClick={() => togglePara(4)}>
