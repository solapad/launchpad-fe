    ...
    <footer className="bg-white dark:bg-gray-800">
      <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
        ...
        <div className="text-center">
          <a href="#" className="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white gap-2">
            <img src="./images/logo.svg" className="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
            SOLaPad <small> v0.1.0</small>
          </a>
          <span className="block text-sm text-center text-gray-500 dark:text-gray-400">
            © {new Date().getFullYear()} SOLAPAD™. All Rights Reserved. Built on top
            <a href="https://solana.com" className="text-purple-600 hover:underline dark:text-purple-500"> Solana Network</a>.
            <br />Cryptocurrency investment is subject to high market risk.
            Solapad is not responsible for any of your crypto losses.
            <br />Please do not construe any statements on this website as to financial advice.
          </span>
